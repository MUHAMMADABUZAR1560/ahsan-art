...
export const metadata: Metadata = {
  ...
  description: "Ahsan Art Creative Studio is Faisalabad's dedicated e-commerce content studio. Founded by Muhammad Ahsan — 7+ years in e-commerce. 500+ projects delivered.",
