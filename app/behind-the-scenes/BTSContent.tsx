              ...
              >
                ...
                <div className="portfolio-card-inner bg-muted">
                  {item.type === "youtube" ? (
                    ...
                    <img
                      src={item.thumbnail}
                      alt={`${item.title} - Behind the Scenes - Ahsan Art`}
                  ...
                  {(item.type === "video" || item.type === "youtube") && (
                    <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                      <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-primary flex items-center justify-center shadow-lg shadow-primary/40 group-hover:scale-110 transition-transform duration-300">
                        <Play className="w-5 h-5 md:w-7 md:h-7 text-white fill-white translate-x-0.5" />
                      </div>
                    </div>
                  )}
